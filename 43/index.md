# Co jest potrzebne na `WarsawJS Workshop #43`?
...
```bash
mkdir -p /tmp/
curl -sSL https://raw.githubusercontent.com/warsawjs/workshop-setup/master/43/.solidarity.json > /tmp/.solidarity.json
