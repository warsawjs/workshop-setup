# Co jest potrzebne na `WarsawJS Workshop #35`?
...
```bash
mkdir -p /tmp/
curl -sSL https://raw.githubusercontent.com/warsawjs/workshop-setup/master/35/.solidarity.json > /tmp/.solidarity.json
