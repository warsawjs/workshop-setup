# Co jest potrzebne na `WarsawJS Workshop #41`?
...
```bash
mkdir -p /tmp/
curl -sSL https://raw.githubusercontent.com/warsawjs/workshop-setup/master/41/.solidarity.json > /tmp/.solidarity.json
