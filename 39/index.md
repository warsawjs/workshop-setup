# Co jest potrzebne na `WarsawJS Workshop #39`?
...
```bash
mkdir -p /tmp/
curl -sSL https://raw.githubusercontent.com/warsawjs/workshop-setup/master/39/.solidarity.json > /tmp/.solidarity.json
