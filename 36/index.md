# Co jest potrzebne na `WarsawJS Workshop #36`?
...
```bash
mkdir -p /tmp/
curl -sSL https://raw.githubusercontent.com/warsawjs/workshop-setup/master/36/.solidarity.json > /tmp/.solidarity.json
