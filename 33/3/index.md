# Grupa Jakuba Skałeckiego: Jak przygotować się do warsztatów?
...
## Konfiguracja projektu `warsawjs-workshop-33-quiz`

```bash
git clone git@github.com:Valian/warsawjs-workshop-33-quiz
cd warsawjs-workshop-33-quiz
