# Co jest potrzebne na `WarsawJS Workshop #40`?
...
```bash
mkdir -p /tmp/
curl -sSL https://raw.githubusercontent.com/warsawjs/workshop-setup/master/40/.solidarity.json > /tmp/.solidarity.json
