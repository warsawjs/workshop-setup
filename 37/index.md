# Co jest potrzebne na `WarsawJS Workshop #37`?
...
```bash
mkdir -p /tmp/
curl -sSL https://raw.githubusercontent.com/warsawjs/workshop-setup/master/37/.solidarity.json > /tmp/.solidarity.json
